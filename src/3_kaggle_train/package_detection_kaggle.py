"""
Drishti-Kavach: Kaggle Obstacle Detection Dataset Packager

Packages `dataset_detection/` into a single zip archive for fast upload to Kaggle.

Usage:
  python src/3_kaggle_train/package_detection_kaggle.py
"""
...
def package_detection_dataset(
    dataset_dir: str = "dataset_detection",
    output_zip: str = "src/3_kaggle_train/raildrishti_detection_kaggle.zip"
):
    ...
    print("=" * 70)
    print(" 📦 PACKAGING OBSTACLE DETECTION DATASET FOR KAGGLE")
    print("=" * 70)
    ...
    print("=" * 70)
    print("\n📋 Next Steps to Train YOLO11m on Kaggle:")
    print("  1. Open https://www.kaggle.com/datasets -> Click '+ New Dataset'")
    print(f"  2. Upload: '{out_zip_path.resolve()}'")
    print("  3. Set Dataset Title to 'raildrishti-detection' and click 'Create'.")
    print("  4. Open 'src/3_kaggle_train/train_yolo11m_kaggle.ipynb' in a new Kaggle Notebook, attach the dataset, and click 'Run All'!")


if __name__ == "__main__":
    package_detection_dataset()
